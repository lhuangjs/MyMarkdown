...
import pre.huangjs.view.MyMarkdown;
...
public class FontFamaiyTest extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        for(String family : fontFamilies){
            ...
            text0.setFont(Font.font(family, 22));

            Text text1 = new Text("默认\t");
            text1.setFont(Font.font(family, 22));

            Text text2 = new Text("粗体\t");
            text2.setFont(Font.font(family, FontWeight.BOLD, 22));

            Text text3 = new Text("斜体\n");
            text3.setFont(Font.font(family, FontPosture.ITALIC, 22));
