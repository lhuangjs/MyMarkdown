...
/**
 * This is a sample example application using JCEF.
...
public class SimpleFrameExample extends JFrame {
    ...
    /**
     * To display a sample browser window, it suffices completely to create an
     ...
     */
    private SimpleFrameExample(String startURL, boolean useOSR, boolean isTransparent) {
        // (1) The view point to JCEF is always the class CefApp. There is only one
        ...
        //     CefBrowser instances. Those events could be sample things like the
    ...
    public static void main(String[] args) {
        // The sample example application is created as anonymous class and points
        ...
        new SimpleFrameExample("http://www.google.com", OS.isLinux(), false);
    }
}