...
public class JavaKeywordsAsync extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Subscription cleanupWhenDone = codeArea.plainTextChanges()
...
//        System.out.println(JavaKeywordsAsync.class.getResource("/java-keywords.css"));
